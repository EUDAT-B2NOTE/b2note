...
def create_b2access_backend(name,b2accessurl):
    ...
    B2ACCESS_TOKEN_URL = '{b2accessurl2}/oauth2/token'.format(b2accessurl2=B2ACCESS_API_URL)
    B2ACCESS_TOKENINFO_URL = '{b2accessurl2}/oauth2/tokeninfo'.format(b2accessurl2=B2ACCESS_API_URL)
    B2ACCESS_AUTH_URL = '{b2accessurl2}/oauth2-as/oauth2-authz'.format(b2accessurl2=B2ACCESS_API_URL)
    B2ACCESS_USERINFO_SUFFIX='/oauth2/userinfo'
    B2ACCESS_USERINFO_URL = '{b2accessurl2}/oauth2/userinfo'.format(b2accessurl2=B2ACCESS_API_URL)
